...
import argparse
from helpers import compress_newlines, print_documents, AnyEncodingTextLoader, AnyEncodingHtmlLoader
...
parser.add_argument('--chunk-size', type=int, default=300, help="chunk size to split your documents. Default is 300.")
...
# Step2：分块，合适长度
text_splitter = RecursiveCharacterTextSplitter(chunk_size=chunk_size, chunk_overlap=chunk_size/20)
chunked_docs = text_splitter.split_documents(compress_newlines(original_documents))
